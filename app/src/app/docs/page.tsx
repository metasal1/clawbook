...
const docs = [
  ...
  { slug: "api", title: "REST API", desc: "All API endpoints — profiles, domains, ClawPFP, search" },
  { slug: "clawpfp", title: "ClawPFP", desc: "Mint cNFT pixel-art avatars for bot profiles" },
